...
<!--[comment]: <> (  - [Masking Policy](#masking-policy)) -->
  ...
  - [Collaboration and AI Use](#collaboration-and-ai-use)
  - [Grading](#grading)
...
### Data Sheets
We expect you to make use of formulae in Google Sheets to make your intermediate calculations. This helps avoid mistakes and makes it easier to fix any mistakes later. It is also how we understand and evaluate some of your work — your instructor may ask you to walk through specific cells and calculations in your spreadsheet during your oral report.  You are required to use your spreadsheet not just to record data but also to do the analysis using formulas in Sheets (not your calculator). If data are entered without using Google Sheets formulas to do the calculations, you may not receive full credit for your work. Your data sheet, coupled with the history feature of Google Sheets, also serves as a time record of your work in the lab. Recording data elsewhere and then later pasting it into Google Sheets is not acceptable. However, it is acceptable to collect data in one lab partner's sheet and then copy it to the other partner's sheet. If doing this, you should include a note to the effect "this data was originally collected in **Name of Lab Partner**'s laboratory notebook and is reproduced here." 

## Collaboration and AI Use
You will collect data with a partner in the lab. We expect individual students to complete the miniquestions, data analysis, and checkpoints for themselves, and to be able to speak to their own understanding of the work during oral reports. (Module 1's oral report is given together with your lab partner, but you should each still be prepared to answer questions about any part of the work.) If you would like to discuss with your lab partner or another classmate while doing analysis in parallel, we encourage that type of collaboration! It may not save you much time, but often working through material together gives a better learning experience. **Just remember that each of you needs to do your own analysis. It is not acceptable to turn in your lab partner's writing or products of their analysis such as a plot they prepared.**

AI tools offer what can seem like an appealing shortcut at many stages of the data analysis, as well as writing and revising  process. However, use of these AI tools is also an energy-intensive process of mixing fact and fiction in our collective information sources in a way that becomes harder and harder to unravel. Use of AI in the creation of a scientific report obscures the voice and analytical judgment of the researcher – in this case, you – who knows directly what happened in the experimental process and has a unique role in evaluating the quality of the results and recommending next steps. Therefore, the use of AI tools is prohibited in this class, and students who use AI for assistance in completing any of the assignments for this course will be in violation of the Harvey Mudd Honor Code. We are interested in understanding your own thought processes and working with you to help you practice communicating your experimental method and articulating your conclusions. 
...
## Grading
The course grade will be calculated based upon your performance on the mini-questions, checkpoints, oral reports, and in-lab conduct.
